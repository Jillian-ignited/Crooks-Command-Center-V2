# db.py — database bootstrap & models (Postgres if DATABASE_URL set; else SQLite)
import os
from datetime import date
from sqlalchemy import (
    create_engine, Column, Integer, String, Text, Date, DateTime, Float, JSON, ForeignKey, Boolean
)
...
if DATABASE_URL:
    # Render Postgres (dpg-…); keep pool small
...
class Asset(Base):
    ...
    rel_path = Column(String(512), nullable=False)   # relative to UPLOAD_DIR
    bytes = Column(Integer, default=0)
    type = Column(String(32))                        # images/videos/data/docs/unknown
