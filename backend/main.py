...
try:
    from routers.intelligence_COMPLETE import router as intelligence_router
...
try:
    from routers.calendar_REAL_DATA import router as calendar_router
...
try:
    from routers.agency_REAL_DATA import router as agency_router
