        ...
        if records:
            ...
            if records and isinstance(records[0], dict):
                ...
                if text_fields:
                    ...
                    all_text = []
                    for record in records[:50]:  # First 50 records
                    ...
                    if all_text:
                        ...
                        analysis["text_analysis"] = analyze_text_content(combined_text)
...
def analyze_csv_structure(text: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if text_columns:
            ...
            # Analyze text content
            all_text = []
            for col in text_columns[:2]:  # First 2 text columns
                text_values = df[col].dropna().astype(str).tolist()
                all_text.extend(text_values[:25])  # First 25 values
